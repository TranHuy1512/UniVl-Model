...
def get_args(description="UniVL on Retrieval Task"):
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="data/youcookii_caption.pickle",
    ...
    parser.add_argument(
        "--train_sim_after_cross",
        action="store_true",
        help="Test retrieval after cross encoder.",
    )
...
def _run_on_single_gpu(
    ...
    for idx1, b1 in enumerate(batch_list_t):
        ...
        for idx2, b2 in enumerate(batch_list_v):
            ...
            b1b2_logits = model.get_similarity_logits(
        ...
        if n_gpu > 1:
            ...
            for dev_id in device_ids:
                ...
                if dev_id == 0:
                    ...
                    devc_batch_list = [
                        tuple(t.to(devc) for t in b) for b in batch_list[s_:e_]
                    ]
    ...
    if args.do_train:
        ...
        for epoch in range(args.epochs):
            ...
            if args.local_rank == 0:
                ...
                logger.info(
                    "The best model is: {}, the R1 is: {:.4f}".format(
